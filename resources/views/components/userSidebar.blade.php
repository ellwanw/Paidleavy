    ...
    <nav class="nav">
        <div>
            ...
            <div class="nav__list">
                <div class="nav__item">
                    <li>
                        <a href="{{Route('user.home')}}" class="nav__link" title="Dashboard">
                ...
                <div class="nav__item">
                    <li>
                        ...
                        <ul class="collapse list-unstyled cuti-karyawan__list" id="cuti-karyawan">
                            <li><a href="{{Route('user.leave.create')}}" class="text-white masterdata__list-item">Leave
                                    Application</a>
                            </li>
                            <li><a href="{{Route('user.historyLeave.index')}}"
